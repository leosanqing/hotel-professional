package cn.hibit.framework.mq.config;

import cn.hibit.framework.common.enums.DocumentEnum;
import cn.hibit.framework.mq.core.RedisMQTemplate;
import cn.hibit.framework.mq.core.interceptor.RedisMessageInterceptor;
import cn.hibit.framework.mq.core.pubsub.AbstractChannelMessageListener;
import cn.hibit.framework.mq.core.stream.AbstractStreamMessageListener;
import cn.hibit.framework.redis.config.HibitRedisAutoConfiguration;
 ...
 */
@Configuration
@AutoConfigureAfter(HibitRedisAutoConfiguration.class)
@Slf4j
public class HibitMQAutoConfiguration {
