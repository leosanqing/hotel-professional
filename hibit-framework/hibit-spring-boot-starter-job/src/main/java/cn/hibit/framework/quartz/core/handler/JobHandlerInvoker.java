package cn.hibit.framework.quartz.core.handler;

import cn.hibit.framework.common.util.date.DateUtils;
import cn.hibit.framework.quartz.core.enums.JobDataKeyEnum;
import cn.hibit.framework.quartz.core.service.JobLogFrameworkService;
...
public class JobHandlerInvoker extends QuartzJobBean {
    ...
    private void updateJobLogResultAsync(Long jobLogId, Date startTime, String data, Throwable exception,
        ...
        // 更新日志
        try {
            jobLogFrameworkService.updateJobLogResultAsync(jobLogId, endTime, (int) DateUtils.diff(endTime, startTime), success, data);
        } catch (Exception ex) {
