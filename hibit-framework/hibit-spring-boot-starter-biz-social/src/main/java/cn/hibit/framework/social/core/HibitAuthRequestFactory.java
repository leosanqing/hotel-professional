package cn.hibit.framework.social.core;

import cn.hibit.framework.social.core.enums.AuthExtendSource;
import cn.hibit.framework.social.core.request.AuthWeChatMiniProgramRequest;
 ...
 */
// TODO @timfruit：单测
public class HibitAuthRequestFactory extends AuthRequestFactory {
    ...
    public HibitAuthRequestFactory(JustAuthProperties properties, AuthStateCache authStateCache) {
