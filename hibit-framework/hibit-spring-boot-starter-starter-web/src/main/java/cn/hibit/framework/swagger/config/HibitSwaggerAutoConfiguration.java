package cn.hibit.framework.swagger.config;
...
@ConditionalOnProperty(prefix = "hibit.swagger", value = "enable", matchIfMissing = true)
@EnableConfigurationProperties(SwaggerProperties.class)
public class HibitSwaggerAutoConfiguration {
