...
public class HibitWebSecurityConfigurerAdapter extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity
                ...
                // 登出地址的配置
                .logout().logoutSuccessHandler(logoutSuccessHandler).logoutRequestMatcher(request ->
                        // 匹配多种用户类型的登出
