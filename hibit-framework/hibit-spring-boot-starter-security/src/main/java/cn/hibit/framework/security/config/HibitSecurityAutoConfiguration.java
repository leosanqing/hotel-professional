package cn.hibit.framework.security.config;

import cn.hibit.framework.security.core.aop.PreAuthenticatedAspect;
import cn.hibit.framework.security.core.authentication.MultiUserDetailsAuthenticationProvider;
import cn.hibit.framework.security.core.context.TransmittableThreadLocalSecurityContextHolderStrategy;
import cn.hibit.framework.security.core.filter.JWTAuthenticationTokenFilter;
import cn.hibit.framework.security.core.handler.AccessDeniedHandlerImpl;
import cn.hibit.framework.security.core.handler.AuthenticationEntryPointImpl;
import cn.hibit.framework.security.core.handler.LogoutSuccessHandlerImpl;
import cn.hibit.framework.security.core.service.SecurityAuthFrameworkService;
 ...
 *
 * 注意，不能和 {@link HibitWebSecurityConfigurerAdapter} 用一个，原因是会导致初始化报错。
...
public class HibitSecurityAutoConfiguration {
